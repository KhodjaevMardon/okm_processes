...
public class UpdateForApproval implements ActionHandler {
	...
	public void execute(ExecutionContext executionContext) throws Exception {
		...
		traceability_map.put("okp:traceability.approve_request_date", dtf.format(now));
		traceability_map.put("okp:traceability.review_date", dtf.format(now));
		traceability_map.put("okp:traceability.review_decision", "accept");
